...
AnimationGroupPtr GLTFLoader::loadAnimationAsync(const std::string& context, IAnimation& animation) THROW_NOT_IMPLEMENTED
...
ArrayBufferView& GLTFLoader::loadBufferViewAsync(const std::string& context, IBufferView& bufferView) THROW_NOT_IMPLEMENTED
...
ArrayBufferView& GLTFLoader::loadImageAsync(const std::string& context, IImage& image) THROW_NOT_IMPLEMENTED

ArrayBufferView GLTFLoader::loadUriAsync(const std::string& context, const std::string& uri) THROW_NOT_IMPLEMENTED
